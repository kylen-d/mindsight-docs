...
| Gaze Following | A participant shifts gaze in the same direction another person is looking | `--gaze-follow` | gaze-following.md |
| Gaze Leadership | Identifying which participant initiates shared attention episodes | `--gaze-leader` | gaze-leadership.md |
| Gaze Aversion | A participant actively avoids eye contact by looking away | `--gaze-aversion` | gaze-aversion.md |
| Attention Span | Duration a participant sustains fixation on a single target | `--attn-span` | attention-span.md |
