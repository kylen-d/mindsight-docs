...
|-------|-------------|--------|
| Detection | `run_detection_step(ctx, ...)` | `ObjectDetection/detection_pipeline.py` |
| Gaze | `run_gaze_step(ctx, ...)` | `GazeTracking/gaze_pipeline.py` |
| Phenomena | `update_phenomena_step(ctx)` | `Phenomena/phenomena_pipeline.py` |
| Data Collection | `collect_frame_data(ctx, ...)` | `DataCollection/data_pipeline.py` |
